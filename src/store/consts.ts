...
export const RUNNING_TRAINING_UNPAUSED = 'RUNNING_TRAINING_UNPAUSED 🏃' as const;
export const RUNNING_TRAINING_PAUSE_TOGGLED = 'RUNNING_TRAINING_PAUSE_TOGGLED 🏃' as const;
