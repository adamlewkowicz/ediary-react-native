...
export const RUNNING_TRAINING_COORD_UPDATED = 'RUNNING_TRAINING_COORD_UPDATED 🏃' as const;
export const RUNNING_TRAINING_POSITION_UPDATED = 'RUNNING_TRAINING_POSITION_UPDATED 🏃' as const;
export const RUNNING_TRAINING_POSITION_FAILED = 'RUNNING_TRAINING_POSITION_FAILED 🏃' as const;