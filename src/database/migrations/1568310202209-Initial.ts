...
export class Initial1568310202209 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query(`CREATE TABLE "product_images" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "url" varchar NOT NULL, "productId" integer NOT NULL, CONSTRAINT "UQ_9fc901c53aea752d77b5392c012" UNIQUE ("url", "productId"))`);
        ...
        await queryRunner.query(`CREATE TABLE "temporary_product_images" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "url" varchar NOT NULL, "productId" integer NOT NULL, CONSTRAINT "UQ_9fc901c53aea752d77b5392c012" UNIQUE ("url", "productId"), CONSTRAINT "FK_b367708bf720c8dd62fc6833161" FOREIGN KEY ("productId") REFERENCES "product" ("id") ON DELETE CASCADE ON UPDATE NO ACTION)`);
    ...
    public async down(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query(`CREATE TABLE "product" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "name" varchar NOT NULL, "barcode" text, "unit" text NOT NULL DEFAULT ('g'), "createdAt" text NOT NULL DEFAULT (CURRENT_TIMESTAMP), "updatedAt" text NOT NULL DEFAULT (CURRENT_TIMESTAMP), "isVerified" boolean, "userId" integer, "macroCarbs" decimal(6,2) NOT NULL DEFAULT (0), "macroProts" decimal(6,2) NOT NULL DEFAULT (0), "macroFats" decimal(6,2) NOT NULL DEFAULT (0), "macroKcal" decimal(6,2) NOT NULL DEFAULT (0), CONSTRAINT "UQ_3e46cda47a776b779fa6faaed10" UNIQUE ("barcode", "isVerified"), CONSTRAINT "UQ_c1dd1975fe160d2190161668c52" UNIQUE ("barcode", "userId"), CONSTRAINT "UQ_905c0fed2f9ceb88491e43331ec" UNIQUE ("name", "isVerified"), CONSTRAINT "CHK_fc8bb6dce3ee11546ec5f9d2bb" CHECK ("unit" IN ('g','ml')))`);
        await queryRunner.query(`INSERT INTO "product"("id", "name", "barcode", "unit", "createdAt", "updatedAt", "isVerified", "userId", "macroCarbs", "macroProts", "macroFats", "macroKcal") SELECT "id", "name", "barcode", "unit", "createdAt", "updatedAt", "isVerified", "userId", "macroCarbs", "macroProts", "macroFats", "macroKcal" FROM "temporary_product"`);
        await queryRunner.query(`DROP TABLE "temporary_product"`);
        await queryRunner.query(`ALTER TABLE "product_images" RENAME TO "temporary_product_images"`);
        await queryRunner.query(`CREATE TABLE "product_images" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "url" varchar NOT NULL, "productId" integer NOT NULL, CONSTRAINT "UQ_9fc901c53aea752d77b5392c012" UNIQUE ("url", "productId"))`);
        await queryRunner.query(`INSERT INTO "product_images"("id", "url", "productId") SELECT "id", "url", "productId" FROM "temporary_product_images"`);
        await queryRunner.query(`DROP TABLE "temporary_product_images"`);
        await queryRunner.query(`ALTER TABLE "product_portions" RENAME TO "temporary_product_portions"`);
        await queryRunner.query(`CREATE TABLE "product_portions" ("productId" integer NOT NULL, "type" varchar NOT NULL, "value" integer NOT NULL, CONSTRAINT "UQ_422bab5f9d32229ab5eec6f1631" UNIQUE ("productId", "type"), PRIMARY KEY ("productId", "type"))`);
        await queryRunner.query(`INSERT INTO "product_portions"("productId", "type", "value") SELECT "productId", "type", "value" FROM "temporary_product_portions"`);
        await queryRunner.query(`DROP TABLE "temporary_product_portions"`);
        await queryRunner.query(`ALTER TABLE "meal_product" RENAME TO "temporary_meal_product"`);
        await queryRunner.query(`CREATE TABLE "meal_product" ("mealId" integer NOT NULL, "productId" integer NOT NULL, "quantity" decimal(4,1) NOT NULL, PRIMARY KEY ("mealId", "productId"))`);
        await queryRunner.query(`INSERT INTO "meal_product"("mealId", "productId", "quantity") SELECT "mealId", "productId", "quantity" FROM "temporary_meal_product"`);
        ...
        await queryRunner.query(`CREATE TABLE "meal" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "name" varchar NOT NULL, "date" text NOT NULL DEFAULT (CURRENT_TIMESTAMP), "userId" integer, "macroCarbs" decimal(6,2) NOT NULL DEFAULT (0), "macroProts" decimal(6,2) NOT NULL DEFAULT (0), "macroFats" decimal(6,2) NOT NULL DEFAULT (0), "macroKcal" decimal(6,2) NOT NULL DEFAULT (0))`);
        await queryRunner.query(`INSERT INTO "meal"("id", "name", "date", "userId", "macroCarbs", "macroProts", "macroFats", "macroKcal") SELECT "id", "name", "date", "userId", "macroCarbs", "macroProts", "macroFats", "macroKcal" FROM "temporary_meal"`);
